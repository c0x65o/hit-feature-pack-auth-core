  ...
  return (
    <div>
      <div style={styles({
        ...
        <div style={styles({ flex: 1, borderTop: `1px solid ${colors.border.subtle}` })} />
        <span style={styles({ fontSize: ts.bodySmall.fontSize, color: colors.text.muted })}>or continue with</span>
        <div style={styles({ flex: 1, borderTop: `1px solid ${colors.border.subtle}` })} />
      </div>
