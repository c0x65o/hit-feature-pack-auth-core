...
export function Departments({ onNavigate }) {
    ...
    return (_jsxs(Page, { title: "Departments", actions: _jsxs(Button, { onClick: () => setCreateModalOpen(true), children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create Department"] }), children: [mutationError && (_jsx(Alert, { variant: "error", title: "Error", className: "mb-4", children: mutationError.message })), _jsx(Card, { children: _jsx(DataTable, { data: departments, columns: [
                    ...
                    setCreateModalOpen(false);
                    resetForm();
                }, title: "Create Department", description: "Create a new organizational department", children: _jsxs("div", { className: "space-y-4 max-h-[60vh] overflow-y-auto", children: [_jsx(Input, { label: "Name", value: name, onChange: setName, placeholder: "e.g., Engineering", required: true }), _jsx(Input, { label: "Code", value: code, onChange: setCode, placeholder: "e.g., ENG" }), _jsx(TextArea, { label: "Description", value: description, onChange: setDescription, placeholder: "Optional description", rows: 3 }), _jsx(Select, { label: "Parent Department", value: parentId, onChange: setParentId, options: parentOptions }), _jsx(Autocomplete, { label: "Manager", placeholder: "Search users\u2026", value: managerUserKey, onChange: setManagerUserKey, minQueryLength: 2, debounceMs: 200, limit: 10, emptyMessage: "No users found", searchingMessage: "Searching\u2026", clearable: true, onSearch: async (query, lim) => {
                    ...
                    setSelectedDepartment(null);
                    resetForm();
                }, title: "Edit Department", description: "Update department details", children: _jsxs("div", { className: "space-y-4 max-h-[60vh] overflow-y-auto", children: [_jsx(Input, { label: "Name", value: name, onChange: setName, placeholder: "e.g., Engineering", required: true }), _jsx(Input, { label: "Code", value: code, onChange: setCode, placeholder: "e.g., ENG" }), _jsx(TextArea, { label: "Description", value: description, onChange: setDescription, placeholder: "Optional description", rows: 3 }), _jsx(Select, { label: "Parent Department", value: parentId, onChange: setParentId, options: parentOptions }), _jsx(Autocomplete, { label: "Manager", placeholder: "Search users\u2026", value: managerUserKey, onChange: setManagerUserKey, minQueryLength: 2, debounceMs: 200, limit: 10, emptyMessage: "No users found", searchingMessage: "Searching\u2026", clearable: true, onSearch: async (query, lim) => {
                                const params = new URLSearchParams();
                                params.set('search', query);
                                params.set('pageSize', String(lim));
                                const res = await fetch(`/api/org/users?${params.toString()}`, { method: 'GET' });
