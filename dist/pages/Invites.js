...
export function Invites({ onNavigate }) {
    ...
    return (_jsxs(Page, { title: "Invitations", description: "Manage user invitations", actions: _jsxs("div", { className: "flex gap-3", children: [_jsxs(Button, { variant: "secondary", onClick: () => refresh(), children: [_jsx(RefreshCw, { size: 16, className: "mr-2" }), "Refresh"] }), _jsxs(Button, { variant: "primary", onClick: () => setCreateModalOpen(true), children: [_jsx(UserPlus, { size: 16, className: "mr-2" }), "Send Invite"] })] }), children: [error && (_jsx(Alert, { variant: "error", title: "Error loading invites", children: error.message })), mutationError && (_jsx(Alert, { variant: "error", title: "Error", children: mutationError.message })), _jsx(Card, { children: !data?.items?.length && !loading ? (_jsx(EmptyState, { icon: _jsx(Clock, { size: 48 }), title: "No pending invitations", description: "Send an invitation to add new users", action: _jsxs(Button, { variant: "primary", onClick: () => setCreateModalOpen(true), children: [_jsx(UserPlus, { size: 16, className: "mr-2" }), "Send Invite"] }) })) : (_jsx(DataTable, { columns: [
                        {
                            key: 'email',
                            label: 'Email',
                            sortable: true,
                    ...
                    })), emptyMessage: "No invitations found", loading: loading, searchable: true, exportable: true, showColumnVisibility: true, total: data?.total, ...serverTable.dataTable, searchDebounceMs: 400, onRefresh: refresh, refreshing: loading, tableId: "admin.invites" })) }), _jsx(Modal, { open: createModalOpen, onClose: () => {
                    setCreateModalOpen(false);
