...
export declare function renderEntityFormField({ keyName, fieldSpec, value, setValue, clearFieldError, error, required, ui, optionSources, referenceRenderers, }: RenderEntityFormFieldArgs): import("react/jsx-runtime").JSX.Element;
