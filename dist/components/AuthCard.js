...
export function AuthCard({ children, className = '' }) {
    return (_jsx("div", { className: `w-full max-w-sm p-6 bg-[var(--hit-surface)] backdrop-blur-sm border border-[var(--hit-border)] rounded-2xl shadow-2xl ${className}`, children: children }));
}
